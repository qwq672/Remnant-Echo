...
本汇编文档采用 [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/) 协议。引用的原文版权归原作者所有。
...
- 新的官方 minecraft.net 文章
- 新的 minecraft.wiki 条目
- 社区公认理论（需标注原文链接）
- 修复断链或过时信息

提交前请确保引用内容**未做任何改写**，保留原文格式。

---

## 📅 更新历史

- **2026-09-18**：初始版本，启动资料收集阶段。覆盖 15 个主题章节，133 个来源页面。
