...
### 6.3 模组自定义内容的「原版关联性」判定

按「补优先于添」原则，所有自定义内容必须满足"原版关联性"：

| 自定义项 | 是否允许 | 原版关联依据 |
|----------|----------|-------------|
| 自定义新纪元名称（如"凋灵之灾"、"苍白之悔"） | ✅ Level 3 | 名称基于原版已有事件（凋灵、苍白花园），作为对原版留白的解读 |
| 自定义叙事文本（残破笔记、铭文） | ✅ Level 1 | 用原版 `written_book` 承载 |
| 自定义"先民储藏室"结构 | ✅ Level 3 | 材质基于原版石砖工艺，作为废弃矿井的结构变体追加 |
| 自定义"残破石碑"方块 | ✅ Level 3 | 材质基于原版石砖衍生，雕刻纹理参考原版 `chiseled_stone_bricks` |
| 自定义"0 号唱片"物品 | ✅ Level 3 | 材质基于原版唱片纹理衍生，作为 22 张原版唱片的合成产物 |
| 自定义"守门人"Boss | ❌ 禁止 | 全新 Boss 实体，无原版依据；改为复用末影龙的 NBT 变体 |
| 自定义新种族（如"光之民"、"暗之子"） | ❌ 禁止 | 完全新生物，无原版依据 |
| 自定义新维度（如"灵界"、"梦境"） | ❌ 禁止 | 完全新维度，无原版依据 |
| 自定义"灵魂能量"机制作为新数值系统 | ❌ 禁止 | 全新游戏机制，无原版依据 |
| 自定义"虚空水晶"方块作为新材质 | ❌ 禁止 | 完全新材质，无原版关联 |
...
| 2026-09-18 | v0.3 | 修订原则为「补优先于添」三级优先级，允许"原版关联性"达标的自定义内容（如先民储藏室、残破石碑、0 号唱片等） | 项目方 |
