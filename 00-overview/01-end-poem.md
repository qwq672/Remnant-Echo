...
### End Poem
- **来源类型**：wikisource
- **原文链接**：<https://en.wikisource.org/wiki/End_Poem>
- **发布时间**：2022-12-07T21:53:25Z

**原文引用：**

> ←End Poem (2022)by Julian Gough→information about this edition
sister projects: Wikipedia article, Wikidata item

Julian Gough wrote the "End Poem" for the ending of the video game Minecraft, where it is presented to the player after they defeat the game's final boss (the Ender Dragon). In 2022, Gough released this version of the text of the poem into the public domain.

The edition presented here is taken from Gough's 2022 public domain release announcement. With the exception of some minor text formatting (such as the use of bold instead of colour to differentiate the voices), this edition is substantially identical to the version Gough sent to Markus Persson in 2011. Some minor differences are also to be expected between this text and the version that eventually was included in the game itself.

4103160End Poem2022Julian Gough
